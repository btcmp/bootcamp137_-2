				...
				<ul class="nav pull-right top-menu">
					...
					<li id="task_notificatoin_bar" class="dropdown"><a
						data-toggle="dropdown" class="dropdown-toggle" href="#"> <span
							class="icon-task-l"> <span class="badge bg-important">6</span>
						</span></a>
				...
				<ul class="sidebar-menu">
					...
					<li class="sub-menu"><a href="javascript:;" class=""> <i
						...
						<ul class="sub">
							...
							<li><a class="" href="view-tabel-pr-detail.html">Request
									Detail</a></li>
							<li><a class="" href="view-tabel-po.html">Order</a></li>
							<li><a class="" href="view-tabel-po-detail.html">Order
									Detail</a></li>
					...
					<li class="sub-menu"><a href="javascript:;" class=""> <i
						...
						<ul class="sub">
							<li><a class="" href="view-transfer-stok.html">transfer
									Stok</a></li>
							<li><a class="" href="detailview-transfer-.html">transfer
									Stok Detail</a></li>
						</ul></li>
					<li class="sub-menu"><a href="javascript:;" class=""> <i
