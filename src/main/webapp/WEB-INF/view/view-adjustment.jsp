				...
				<div class="col-lg-2"></div>
                  <div class="col-lg-10">
                      <section class="panel">
						  ...
						  <div class="col-sm-9">
						  <div class="nav search-row" id="top_menu" style="margin-bottom:30px;">
							<!--  search form start -->
							<ul class="nav top-menu">                    
								<li>
									<form class="navbar-form">
										<label for="pickup">Search date:</label>
						...
						<div class="col-sm-1" style="float:left; margin-top:15px;">
							<a class="btn btn-primary" id="btn-export"><span class="icon_folder_download"></span> Export</a>
						</div>
						<div class="col-sm-2" style="float:right; margin-top:15px;">
							<a class="btn btn-primary" id="btn-add"><span class="icon_plus_alt"></span> Create</a>
						</div>
						<br>
                           ...
                           <thead>
							...
							<tbody>
                              <tr>
                                 ...
                                 <td>
                                  <div class="btn-group">
                                      <a class="btn btn-primary" id="btn-edit"><i class="icon_pencil-edit"></i></a>
                                  </div>
                                  </td>
                              </tr>
							</tbody>
